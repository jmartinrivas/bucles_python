...
if promedio >= 90:
    print("La calificacion promedio fue = A")
elif promedio >= 80:
    print("La calificacion promedio fue = B")
elif promedio >= 70:
    print("La calificacion promedio fue = C")
elif promedio >= 60:
    print("La calificacion promedio fue = D")
else: 
    print("La calificacion promedio fue = F")        
